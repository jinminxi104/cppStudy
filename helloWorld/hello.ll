...
define i32 @0() #0 {
  ...
  %4 = call dereferenceable(160) %"class.std::__1::basic_ostream"* @1(%"class.std::__1::basic_ostream"* dereferenceable(160) @_ZNSt3__14coutE, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i32 0, i32 0))
  store %"class.std::__1::basic_ostream"* %4, %"class.std::__1::basic_ostream"** %1, align 8
  store %"class.std::__1::basic_ostream"* (%"class.std::__1::basic_ostream"*)* @2, %"class.std::__1::basic_ostream"* (%"class.std::__1::basic_ostream"*)** %2, align 8
...
; Function Attrs: ssp uwtable
define linkonce_odr dereferenceable(160) %"class.std::__1::basic_ostream"* @1(%"class.std::__1::basic_ostream"* dereferenceable(160) %__os, i8* %__str) #0 {
  %1 = alloca %"class.std::__1::basic_ostream"*, align 8
  %2 = alloca i8*, align 8
  ...
  %6 = call i64 @4(i8* %5)
  %7 = call dereferenceable(160) %"class.std::__1::basic_ostream"* @3(%"class.std::__1::basic_ostream"* dereferenceable(160) %3, i8* %4, i64 %6)
  ret %"class.std::__1::basic_ostream"* %7
}

; Function Attrs: alwaysinline inlinehint ssp uwtable
define linkonce_odr hidden dereferenceable(160) %"class.std::__1::basic_ostream"* @2(%"class.std::__1::basic_ostream"* dereferenceable(160) %__os) #1 personality i32 (...)* @__gxx_personality_v0 {
...
; Function Attrs: ssp uwtable
define linkonce_odr dereferenceable(160) %"class.std::__1::basic_ostream"* @3(%"class.std::__1::basic_ostream"* dereferenceable(160) %__os, i8* %__str, i64 %__len) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %1 = alloca %"class.std::__1::ctype"*, align 8
  %2 = alloca i8, align 1
  %3 = alloca %"class.std::__1::locale"*, align 8
  %4 = alloca %"class.std::__1::basic_ios"*, align 8
...
; <label>:83                                      ; preds = %81, %77
  ...
  %110 = call zeroext i1 @7(i32 %107, i32 %109) #5
...
; <label>:142                                     ; preds = %_ZNKSt3__19basic_iosIcNS_11char_traitsIcEEE4fillEv.exit
  ...
  %145 = invoke %"class.std::__1::basic_streambuf"* @5(%"class.std::__1::basic_streambuf"* %144, i8* %61, i8* %84, i8* %87, %"class.std::__1::ios_base"* dereferenceable(136) %96, i8 signext %141)
...
; <label>:183                                     ; preds = %182, %171
  ...
  %185 = call i8* @__cxa_begin_catch(i8* %184) #5
...
; <label>:208                                     ; preds = %198, %.body
  ...
  call void @6(i8* %210) #7
  unreachable
}

; Function Attrs: inlinehint ssp uwtable
define linkonce_odr i64 @4(i8* %__s) #2 align 2 {
  %1 = alloca i8*, align 8
...
; Function Attrs: ssp uwtable
define linkonce_odr hidden %"class.std::__1::basic_streambuf"* @5(%"class.std::__1::basic_streambuf"* %__s.coerce, i8* %__ob, i8* %__op, i8* %__oe, %"class.std::__1::ios_base"* dereferenceable(136) %__iob, i8 signext %__fl) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
...
; <label>:146                                     ; preds = %143
  ...
  call void @llvm.memset.p0i8.i64(i8* %162, i8 0, i64 24, i32 8, i1 false) #5
...
define linkonce_odr hidden void @6(i8*) #4 {
...
define linkonce_odr zeroext i1 @7(i32 %__c1, i32 %__c2) #6 align 2 {
...
; Function Attrs: inlinehint nounwind ssp uwtable
define linkonce_odr i32 @8() #6 align 2 {
  ret i32 -1
}
